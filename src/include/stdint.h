...
/*! \todo Find a better place for this typedef. Putting it here is not
    consistent with C99.
 */
typedef int64_t                 sig_atomic_t;

/* \warning This is a type which does not exist in C99. */
typedef uint64_t                usig_atomic_t;
...
# define USIG_ATOMIC_MAX        UINT64_MAX

# define INT_ATOMIC_MAX_BITLENGTH (64)
